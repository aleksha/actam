...
void findTPCtracks(){
  ...
  TH2F* hE1E2 = new TH2F("hE1E2"," ; energy, a.u.;entries",  50, 0., 5 , 50, 0., 5.);
  TH2F* hE1E3 = new TH2F("hE1E3"," ; energy, a.u.;entries",  50, 0., 5 , 50, 0., 5.);
  TH2F* hE2E3 = new TH2F("hE2E3"," ; energy, a.u.;entries",  50, 0., 5 , 50, 0., 5.);

  TH2F* hE2E1 = new TH2F("hE1E2"," ; E2, MeV ; E1, MeV",  50, 0., 5 , 50, 0., 5.);
...
//==============================================================================
  ...
  while(n_ev<process_ev){
    ...
    if(ev!=EVENT){
      ...
      hE1E2->Fill( h1->Integral() , h2->Integral() );
      hE1E3->Fill( h1->Integral() , h3->Integral() );
      hE2E3->Fill( h2->Integral() , h3->Integral() );

      hE2E1->Fill( h2->Integral() , h1->Integral() );
